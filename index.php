...
<head>
    ...
    * {
    ...
    .hero {
        ...
        margin: 20px;
        border-radius: 16px;
        background: linear-gradient(135deg, rgba(26, 28, 28, 0.7), rgba(26, 28, 28, 0.5)), url('assets/img/img/850x450-Pix_9-1.jpg') center/cover no-repeat;
        text-align: center;
        padding: 60px 40px;
        position: relative;
        overflow: hidden
...
<body>
        ...
        <div class="collections-container">
            <div class="collection-card">
                <div class="collection-image">
                    <img src="<?php echo get_image_url('assets/img/img/850x450-Pix_9-1.jpg'); ?>"
                        alt="Printemps - Été 2025"
                ...
                <div class="collection-info">
                    ...
                    <a href="shop.php?category=printemps-ete" class="collection-btn">Explorer</a>
                </div>
            </div>

            <div class="collection-card">
                <div class="collection-image">
                    <img src="<?php echo get_image_url('assets/img/img/9.webp'); ?>" alt="Collection Classique"
                ...
                <div class="collection-info">
                    ...
                    <a href="shop.php?category=classique" class="collection-btn">Explorer</a>
                </div>
            </div>

            <div class="collection-card">
                <div class="collection-image">
                    <img src="<?php echo get_image_url('assets/img/img/Gear-Cargo-Pants-are-Back-1302952122.webp'); ?>"
                ...
                <div class="collection-info">
                    ...
                    <a href="shop.php?category=exclusive" class="collection-btn">Explorer</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div style="text-align: center; margin-top: 40px;">
            <a href="shop.php" class="hero-btn" style="background: var(--beige-dark); color: var(--bg-white);">
