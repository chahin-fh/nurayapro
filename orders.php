                    ...
                    <div class="order-item">
                        <div class="order-info">
                            ...
                            <div class="order-meta">
                                ...
                                <strong><?php echo number_format($order['total'], 2); ?> DT</strong>
                            </div>
            ...
            <?php else: ?>
                <div class="no-orders">
                    ...
                    <p style="margin-top: 15px;">
                        <a href="src/Controllers/produits/index.php" style="color: var(--beige-dark); font-weight: 600; text-decoration: none;">
