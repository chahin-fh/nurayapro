...
<head>
    ...
    <style>
        ...
        * {
        ...
        .product-card:not(:has(.add-to-cart:hover)) {
            cursor: pointer
        }
    ...
    <section class="featured-products">
        ...
        <div class="products">
            <?php while ($t = mysqli_fetch_assoc($result)):
                $i++;
                ?>
                <div class="product-card" data-product-id="<?php echo $t['product_id']; ?>"
                    data-name="<?php echo htmlspecialchars($t['name']); ?>" data-price="<?php echo $t['price']; ?>"
                    data-description="<?php echo htmlspecialchars($t['description'] ?? 'High-quality product'); ?>"
                    data-image="<?php echo strpos($t['image_url'], 'http') === 0 ? $t['image_url'] : 'uploads/' . $t['image_url']; ?>">
