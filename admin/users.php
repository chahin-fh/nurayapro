                ...
                <tr>
                    <td>
                        <div style="display: flex; align-items: center; gap: 12px;">
                            <div style="width: 40px; height: 40px; background: var(--beige-dark); color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700;">
                    ...
                    <td>
                        <span class="badge <?php echo $user['role'] === 'admin' ? 'badge-admin' : 'badge-user'; ?>" style="background: <?php echo $user['role'] === 'admin' ? 'rgba(28,28,28,0.1)' : 'rgba(200,182,166,0.1)'; ?>; color: <?php echo $user['role'] === 'admin' ? 'var(--text-dark)' : 'var(--beige-dark)'; ?>;">
                            <?php echo $user['role']; ?>
                        </span>
                    </td>
        ...
        <div class="main-content">
            ...
            <form class="filters" method="GET">
                <div class="filter-group">
                    ...
                    <input type="text" name="search" placeholder="Nom, email..." value="<?php echo htmlspecialchars($search); ?>">
                </div>
                <div class="filter-group">
                    <label>Rôle</label>
                    <select name="role">
