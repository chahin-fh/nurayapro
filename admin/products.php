        ...
        <tbody>
            <?php while ($product = mysqli_fetch_assoc($products_result)): ?>
                <tr>
                    ...
                    <td>
                        <div style="font-weight: 700; color: var(--text-dark);"><?php echo htmlspecialchars($product['name']); ?></div>
                        <div style="font-size: 12px; color: var(--text-gray);">SKU: <?php echo htmlspecialchars($product['sku'] ?? 'N/A'); ?></div>
                    </td>
