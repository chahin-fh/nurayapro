    ...
    <div class="admin-layout">
        ...
        <div class="main-content">
            <div class="page-header">
                <div>
                    <a href="products.php" style="color: var(--text-gray); text-decoration: none; font-size: 14px; display: block; margin-bottom: 10px;">
                    ...
                    <div class="card">
                        ...
                        <div class="form-row-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="compare_price" value="<?php echo $product['compare_price'] ?? ''; ?>">
                            </div>
                            <div class="form-group">
                                <label>Référence produit</label>
                                <div style="display: flex; gap: 10px;">
                                    <input type="text" name="sku" id="sku_input" value="<?php echo htmlspecialchars($product['sku'] ?? ''); ?>" placeholder="Générer ou saisir...">
                                    <button type="button" class="btn btn-secondary" onclick="generateSKU()" style="padding: 10px; height: 43px;"><i class="fas fa-sync"></i></button>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Stock actuel</label>
                                <input type="number" name="stock_quantity" value="<?php echo $product['stock_quantity'] ?? 0; ?>" required>
                            </div>
                            <div class="form-group">
                ...
                <div class="right-col">
                    <div class="card">
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            ...
                            <select name="is_active">
                                <option value="1" <?php echo ($product['is_active'] ?? 1) == 1 ? 'selected' : ''; ?>>Actif</option>
                                <option value="0" <?php echo ($product['is_active'] ?? 1) == 0 ? 'selected' : ''; ?>>Inactif</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Mise en avant</label>
                            <select name="is_featured">
                                <option value="0" <?php echo ($product['is_featured'] ?? 0) == 0 ? 'selected' : ''; ?>>Non</option>
                                <option value="1" <?php echo ($product['is_featured'] ?? 0) == 1 ? 'selected' : ''; ?>>Oui</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            ...
                            <input type="file" name="product_image" id="product_image" accept="image/*" onchange="previewLocalImage(this)">
